package org.processmining.plugins.hybridclusterminer.pattern.spmf.sequentialpatterns;
 ...
 */
public class SequenceDatabase extends ArrayList<int[]> {
	...
	public void printDatabaseStats() {
		...
		System.out.println("Number of sequences : " + this.size());
		
		// Calculate the average size of sequences in this database
		double meansize = ((float)itemOccurrenceCount) / ((float)this.size());
